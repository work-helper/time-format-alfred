...
iterRunes:
	for i := 0; i < inputLen; i++ {
		...
		case stateDigitDashWs:
			...
			switch r {
			case ',':
				if inputLen == len("2014-05-11 08:20:13,787") {
		...
		case stateDigitAlpha:
			...
			switch {
			case inputLen == len("02 Jan 2006, 15:04"):
				return parse("02 Jan 2006, 15:04", datestr, loc)
			case inputLen == len("02 Jan 2006, 15:04:05"):
				return parse("02 Jan 2006, 15:04:05", datestr, loc)
			case inputLen == len("2006年01月02日"):
				return parse("2006年01月02日", datestr, loc)
			case inputLen == len("2006年01月02日 15:04"):
	...
	case stateDigitDash: // starts digit then dash 02-
		// 2006-01-02
		// 2006-01
		if inputLen == len("2014-04-26") {
			return parse("2006-01-02", datestr, loc)
		} else if inputLen == len("2014-04") {
	...
	case stateDigitDashTOffsetColon:
		...
		// 2006-01-02T15:04:05-07:00
		if inputLen == len("2006-01-02T15:04:05 -07:00 MST") {
			return parse("2006-01-02T15:04:05 -07:00 MST", datestr, loc)
		}
	...
	case stateDigitDashWsWsAlpha:
		...
		if inputLen > len("2006-01-02 03:04:05") {
	...
	case stateAlphaWSAlphaColonAlphaOffsetAlpha:
		// Fri Jul 03 2015 18:04:07 GMT+0100 (GMT Daylight Time)
		if inputLen > len("Mon Jan 02 2006 15:04:05 MST-0700") {
